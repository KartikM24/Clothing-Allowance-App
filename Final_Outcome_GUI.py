...
top_frame = tkinter.LabelFrame(root, text="Account Details", font=("Lato", 12, "bold"), bg='#000000', fg='#2F8EA1') #Georgia, Garamond, Lato
...
details_label = tkinter.Label(top_frame, textvariable=account_details, font=("Lato", 11, "bold"), bg='#2F8EA1', fg='#FFFFFF')
...
submit_button = tkinter.Button(bottom_frame, text="Submit", command=manage_action, font=("Lato", 11, "bold"), bg='#2F8EA1', fg='#FFFFFF')
