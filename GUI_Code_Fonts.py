...
top_frame = tkinter.LabelFrame(root, text="Account Details", font=("Garamond", 12, "bold")) #Garamond, Lato, Georgia
...
message_label = ttk.Label(top_frame, textvariable=message_text, wraplength=1000, font=("Garamond", 11))
...
details_label = ttk.Label(top_frame, textvariable=account_details, font=("Garamond", 11, "bold"))
...
account_label = ttk.Label(bottom_frame, text="Account: ", font=("Garamond", 11, "bold"))
...
action_label = ttk.Label(bottom_frame, text="Action:", font=("Garamond", 11, "bold"))
...
amount_label = ttk.Label(bottom_frame, text="Amount:", font=("Garamond", 11, "bold"))
...
amount_entry = ttk.Entry(bottom_frame, textvariable=amount, font=("Garamond", 10))
amount_entry.grid(row=5, column=1, padx=10, pady=3, sticky="WE")

#Create a submit button
submit_button = tkinter.Button(bottom_frame, text="Submit", command=manage_action, font=("Garamond", 11, "bold"))
...
action_feedback_label = ttk.Label(bottom_frame, textvariable=action_feedback, font=("Garamond", 12))
...
bonus_label = ttk.Label(bottom_frame, textvariable=bonus_message, wraplength=1000, font=("Garamond", 12))
